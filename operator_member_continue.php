        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            <?php
                ...
                if(isset($_SESSION['u_id'])) {
                    if(($_SESSION['u_id'] == 'operator') || ($_SESSION['u_id'] == 'admin') || ($_SESSION['u_id'] == 'accounting') || ($_SESSION['u_id'] == 'master')) {
            ...
            <div class="member_continue_year">
                ...
                <?php
                    if($success) {
                        echo ' - 근속기간은 최초 입대일부터 산정하되 휴식기간 등(찬양대에 봉사하지 않은 기간)은 제외합니다.<br>';
                        echo ' - 휴식 대원의 복귀 및 제적 탈퇴하였던 자가 재입대한 경우도 이와 같이 산정합니다.<br>';
