<div class="w3-bar w3-blue">
    <?php  if(($_SESSION['u_id'] == 'admin') || ($_SESSION['u_id'] == 'operator')) { ?>
        <a href="operator_att_stat_day.php" class="w3-bar-item w3-button w3-mobile">(파트) 일별 출석통계</a>
    <?php } ?>
    <?php  if(($_SESSION['u_id'] == 'admin') || ($_SESSION['u_id'] == 'operator') || ($_SESSION['u_id'] == 'editor')) { ?>
    ...
    <?php } ?>
    <?php  if(($_SESSION['u_id'] == 'admin') || ($_SESSION['u_id'] == 'operator') || ($_SESSION['u_id'] == 'accounting')) { ?>
